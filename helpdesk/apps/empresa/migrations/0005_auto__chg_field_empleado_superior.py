...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Empleado.superior'
        db.alter_column('empresa_empleado', 'superior_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['empresa.Empleado'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Empleado.superior'
        db.alter_column('empresa_empleado', 'superior_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['empresa.Empleado']))
